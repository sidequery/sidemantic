...
- **Formats:** Sidemantic, Cube, MetricFlow (dbt), LookML, Hex, Rill, Superset, Omni, BSL, Snowflake Cortex, Malloy, OSI, AtScale SML, ThoughtSpot TML (YAML; mature, REST API export/import, OSI participant)
