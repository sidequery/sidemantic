...
| Feature | Cube | MetricFlow | LookML | Notes |
|---------|------|------------|--------|-------|
| **Models** | ✅ | ✅ | ✅ | Full bidirectional support |
| **Dimensions** | ✅ | ✅ | ✅ | Full bidirectional support |
| **Time Dimensions** | ✅ | ✅ | ✅ | LookML: uses dimension_group |
| **Simple Metrics** | ✅ | ✅ | ✅ | sum, count, avg, etc. |
| **Ratio Metrics** | ✅ | ✅ | ✅ | Cube/LookML: exported as calculated measure |
| **Derived Metrics** | ✅ | ✅ | ✅ | Formula-based metrics |
| **Cumulative Metrics** | ✅ | ✅ | ⚠️ | Cube: uses rolling_window; LookML: limited |
| **Time Comparison** | ⚠️ | ✅ | ⚠️ | Exported as calculated measure with note |
| **Relationships** | ✅ | ✅ | ⚠️ | LookML: limited inference from views |
| **Segments** | ✅ | ⚠️ | ✅ | LookML: uses filter; MetricFlow: stored in meta |
| **Metric Filters** | ✅ | ⚠️ | ✅ | LookML/Cube: full support; MetricFlow: stored in meta |
| **Parameters** | ❌ | ❌ | ❌ | Not supported by target formats |
| **Hierarchies** | ⚠️ | ⚠️ | ⚠️ | Stored in meta or drill_members |
| **Inheritance** | ✅ | ✅ | ✅ | Resolved before export (fully merged) |
| **Jinja Templates** | ✅ | ✅ | ⚠️ | LookML: uses Liquid instead of Jinja |
| **Metadata Fields** | ⚠️ | ⚠️ | ⚠️ | format exported; others in meta |
