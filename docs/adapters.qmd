...
| Feature | Sidemantic | Cube | MetricFlow | LookML | Hex | Rill | Superset | Notes |
|---------|------------|------|------------|--------|-----|------|----------|-------|
| **Models** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | All formats support models/tables |
| **Dimensions** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | All formats support dimensions |
| **Relationships** | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | Rill/Superset: single-model only |
...
| **Cumulative Metrics** | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | Cube: rolling_window; others: exported as SQL |
| **Time Comparison** | ✅ | ⚠️ | ✅ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | MetricFlow: native; others: exported as calculated measure |
| **Segments** | ✅ | ✅ | ⚠️ | ✅ | ⚠️ | ❌ | ❌ | MetricFlow/Hex: stored in meta; Rill/Superset: not supported |
| **Metric Filters** | ✅ | ✅ | ⚠️ | ✅ | ✅ | ⚠️ | ❌ | MetricFlow: stored in meta; Rill: basic support; Superset: none |
| **Parameters** | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | Sidemantic-only feature |
| **Hierarchies** | ✅ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ❌ | ❌ | Cube/LookML: drill_members; MetricFlow/Hex: meta; Rill/Superset: none |
| **Inheritance** | ✅ | ⚠️ | ⚠️ | ✅ | ⚠️ | ⚠️ | ⚠️ | LookML: native extends; others: resolved before export |
| **Jinja Templates** | ✅ | ✅ | ✅ | ⚠️ | ✅ | ✅ | ✅ | LookML uses Liquid instead of Jinja |
| **Metadata Fields** | ✅ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ✅ | Superset: verbose_name for label; others: label/description preserved |
