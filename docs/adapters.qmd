...
Want to add support for another format? See our [adapter development guide](https://github.com/sidequery/sidemantic/blob/main/CONTRIBUTING.md) or file a feature request.
