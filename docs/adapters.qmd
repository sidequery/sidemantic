...
| Feature | Sidemantic | Cube | MetricFlow | LookML | Hex | Rill | Notes |
|---------|------------|------|------------|--------|-----|------|-------|
| **Models** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | All formats support models/tables |
| **Dimensions** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | All formats support dimensions |
| **Relationships** | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | Rill: single-model only |
...
| **Ratio Metrics** | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠️ | Rill: exported as derived metric with formula |
| **Derived Metrics** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | All formats support calculated metrics |
| **Cumulative Metrics** | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ⚠️ | Cube: rolling_window; LookML/Hex/Rill: exported as SQL |
| **Time Comparison** | ✅ | ⚠️ | ✅ | ⚠️ | ⚠️ | ⚠️ | MetricFlow: native; others: exported as calculated measure |
| **Segments** | ✅ | ✅ | ⚠️ | ✅ | ⚠️ | ❌ | MetricFlow/Hex: stored in meta; Rill: not supported |
| **Metric Filters** | ✅ | ✅ | ⚠️ | ✅ | ✅ | ⚠️ | MetricFlow: stored in meta; Rill: basic support only |
| **Parameters** | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | Sidemantic-only feature |
| **Hierarchies** | ✅ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ❌ | Cube/LookML: drill_members; MetricFlow/Hex: meta; Rill: none |
| **Inheritance** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Resolved before export (fully merged definitions) |
| **Jinja Templates** | ✅ | ✅ | ✅ | ⚠️ | ✅ | ✅ | LookML uses Liquid instead of Jinja |
| **Metadata Fields** | ✅ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | Label/description preserved; format/drill_fields in meta |
