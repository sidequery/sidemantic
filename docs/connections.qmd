...
Get your token from [motherduck.com](https://motherduck.com).
...
**See also:** [MotherDuck example](https://github.com/sidequery/sidemantic/tree/main/examples/motherduck_example.py)
