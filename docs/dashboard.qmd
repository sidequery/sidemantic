...
try:
    ...
    # Install sidemantic without deps - Marimo loads pydantic from Pyodide packages
    # (avoids typing-extensions conflict: pydantic-core 2.41+ needs >=4.14.1, Pyodide has 4.11.0)
