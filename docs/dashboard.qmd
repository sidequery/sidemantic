...
try:
    ...
    # Load pydantic from Pyodide packages (has compatible typing-extensions)
    import pyodide_js
    await pyodide_js.loadPackage(['pydantic', 'pyyaml', 'jinja2'])
    # Install missing pure-Python deps and sidemantic
