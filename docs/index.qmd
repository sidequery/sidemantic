...
Sidemantic is a semantic layer that turns messy data modeling into clean SQL. Define your business metrics once in YAML, then query them with familiar SQL syntax. No more copy-pasting calculations or joining the same tables over and over.
