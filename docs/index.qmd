---
title: "Sidemantic"
subtitle: "Define metrics once, query them anywhere with SQL"
---

Sidemantic is a semantic layer that turns messy data modeling into clean SQL. Define your business metrics once in YAML, then query them with familiar SQL or Python.
...
**Smart automation.** Automatic joins across models, dependency detection, and multi-hop relationship discovery mean less configuration, more productivity.

**Rich metric types.** From simple aggregations to ratios, time comparisons, conversion funnels, and cumulative calculations.

**Flexible and powerful.** Jinja2 templating, reusable segments, hierarchies, and inheritance let you build sophisticated analytics without the complexity.
