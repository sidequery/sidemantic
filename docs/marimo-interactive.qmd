---
title: "Sidemantic Interactive Demo"
page-layout: article
filters:
  - marimo-team/marimo
pyproject: |
...
try:
    ...
    await micropip.install(["sidemantic==0.2.5"], deps=False)
    import sidemantic  # type: ignore
```
...
# Month-over-month revenue comparison using Sidemantic time_comparison metric
mom_data, _ = run_query(
    metrics=["orders.revenue", "orders.revenue_mom_pct"],
