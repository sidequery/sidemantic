...
try:
    ...
    # Install typing-extensions first to avoid version conflicts
    await micropip.install(["typing-extensions>=4.14.0"], keep_going=True)
    await micropip.install(["sidemantic==0.2.7"], deps=False)
    import sidemantic  # type: ignore
```
