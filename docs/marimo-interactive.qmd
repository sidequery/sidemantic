...
mo.vstack([
    mo.md('## Data Model'),
    mo.accordion({
        "Python Definition": mo.ui.code_editor(value=python_src, language='python', disabled=True, min_height=360),
        "YAML Definition": mo.ui.code_editor(value=yaml_src, language='yaml', disabled=True, min_height=420),
    }),
])
```
