...
```json
{
  "mcpServers": {
    "sidemantic": {
      "command": "sidemantic",
      "args": ["mcp-serve", "./path/to/models", "--db", "data/warehouse.db"]
    }
  }
}
```
...
```json
{
  "mcpServers": {
    "sidemantic": {
      "command": "sidemantic",
      "args": ["mcp-serve", "${HOME}/projects/my-semantic-layer"],
      "env": {
...
```json
{
  "mcpServers": {
    "sidemantic-dev": {
      "command": "sidemantic",
      "args": ["mcp-serve", "./models", "--db", "dev.db"]
    },
    "sidemantic-prod": {
      "command": "sidemantic",
      "args": ["mcp-serve", "./models", "--db", "prod.db"]
    }
  }
}
```
...
Ensure `sidemantic` is installed and in your PATH:

```bash
which sidemantic
# Should show path to sidemantic executable
```
...
```json
{
  "mcpServers": {
    "sidemantic": {
      "command": "/path/to/venv/bin/sidemantic",
