...
export interface InitOutput {
    ...
    readonly wasm_analyze_migrator_query: (a: number, b: number, c: number) => void;
    readonly wasm_build_preaggregation_refresh_statements: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number) => void;
    readonly wasm_build_symmetric_aggregate_sql: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
    readonly wasm_calculate_preaggregation_benefit_score: (a: number, b: number, c: number, d: number) => void;
    readonly wasm_chart_auto_detect_columns: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_chart_encoding_type: (a: number, b: number, c: number) => void;
    readonly wasm_chart_format_label: (a: number, b: number, c: number) => void;
    readonly wasm_chart_select_type: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    readonly wasm_compile_with_yaml_query: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_detect_adapter_kind: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_dimension_sql_expr_with_yaml: (a: number, b: number, c: number) => void;
    readonly wasm_dimension_with_granularity_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_evaluate_table_calculation_expression: (a: number, b: number, c: number) => void;
    readonly wasm_extract_column_references: (a: number, b: number, c: number) => void;
    readonly wasm_extract_metric_dependencies_from_yaml: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly wasm_extract_preaggregation_patterns: (a: number, b: number, c: number) => void;
    readonly wasm_find_models_for_query: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_find_relationship_path_with_yaml: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly wasm_format_parameter_value_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_generate_catalog_metadata_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_generate_preaggregation_definition: (a: number, b: number, c: number) => void;
    readonly wasm_generate_preaggregation_materialization_sql_with_yaml: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly wasm_generate_preaggregation_name: (a: number, b: number, c: number) => void;
    readonly wasm_generate_time_comparison_sql: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: bigint, l: number, m: number) => void;
    readonly wasm_interpolate_sql_with_parameters_with_yaml: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly wasm_is_relative_date: (a: number, b: number) => number;
    readonly wasm_is_sql_template: (a: number, b: number) => number;
    readonly wasm_load_graph_with_sql: (a: number, b: number, c: number) => void;
    readonly wasm_load_graph_with_yaml: (a: number, b: number, c: number) => void;
    readonly wasm_metric_is_simple_aggregation: (a: number, b: number, c: number) => void;
    readonly wasm_metric_sql_expr: (a: number, b: number, c: number) => void;
    readonly wasm_metric_to_sql: (a: number, b: number, c: number) => void;
    readonly wasm_model_find_dimension_index_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_model_find_metric_index_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_model_find_pre_aggregation_index_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_model_find_segment_index_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_model_get_drill_down_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_model_get_drill_up_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_model_get_hierarchy_path_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_needs_symmetric_aggregate: (a: number, b: number, c: number) => number;
    readonly wasm_parse_reference_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_parse_relative_date: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_parse_simple_metric_aggregation: (a: number, b: number, c: number) => void;
    readonly wasm_parse_sql_definitions_payload: (a: number, b: number, c: number) => void;
    readonly wasm_parse_sql_graph_definitions_payload: (a: number, b: number, c: number) => void;
    readonly wasm_parse_sql_model_payload: (a: number, b: number, c: number) => void;
    readonly wasm_parse_sql_statement_blocks_payload: (a: number, b: number, c: number) => void;
    readonly wasm_recommend_preaggregation_patterns: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    readonly wasm_relationship_foreign_key_columns_with_yaml: (a: number, b: number, c: number) => void;
    readonly wasm_relationship_primary_key_columns_with_yaml: (a: number, b: number, c: number) => void;
    readonly wasm_relationship_related_key_with_yaml: (a: number, b: number, c: number) => void;
    readonly wasm_relationship_sql_expr_with_yaml: (a: number, b: number, c: number) => void;
    readonly wasm_relative_date_to_range: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly wasm_render_sql_template: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_resolve_metric_inheritance: (a: number, b: number, c: number) => void;
    readonly wasm_resolve_model_inheritance_with_yaml: (a: number, b: number, c: number) => void;
    readonly wasm_rewrite_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_segment_get_sql_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_summarize_preaggregation_patterns: (a: number, b: number, c: number, d: number) => void;
    readonly wasm_time_comparison_offset_interval: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number) => void;
    readonly wasm_time_comparison_sql_offset: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number) => void;
    readonly wasm_trailing_period_sql_interval: (a: number, b: bigint, c: number, d: number) => void;
    readonly wasm_validate_engine_refresh_sql_compatibility: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_validate_metric_payload: (a: number, b: number, c: number) => void;
    readonly wasm_validate_model_payload: (a: number, b: number, c: number) => void;
    readonly wasm_validate_models_yaml: (a: number, b: number, c: number) => void;
    readonly wasm_validate_parameter_payload: (a: number, b: number, c: number) => void;
    readonly wasm_validate_query_references: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly wasm_validate_query_with_yaml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly wasm_validate_table_calculation_payload: (a: number, b: number, c: number) => void;
    readonly wasm_validate_table_formula_expression: (a: number, b: number, c: number) => void;
    readonly wasm_validate_query_references_with_yaml: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
