...
pub use wasm::{
    ...
    wasm_chart_select_type, wasm_compile_with_semantic_input, wasm_compile_with_yaml_query,
    wasm_detect_adapter_kind, wasm_dimension_sql_expr_with_yaml,
    wasm_dimension_with_granularity_with_yaml, wasm_evaluate_table_calculation_expression,
    wasm_extract_column_references, wasm_extract_metric_dependencies_from_yaml,
    ...
    wasm_generate_catalog_metadata_with_yaml, wasm_generate_preaggregation_definition,
    ...
    wasm_rewrite_with_semantic_input_context, wasm_rewrite_with_yaml,
    wasm_segment_get_sql_with_yaml, wasm_summarize_preaggregation_patterns,
