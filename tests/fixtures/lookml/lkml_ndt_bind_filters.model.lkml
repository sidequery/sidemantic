# Source: joshtemple/lkml (MIT License)
# File: tests/resources/github/pass_filters_TO_NDT.model.lkml
# Tests: native derived tables with bind_filters, SQL_TABLE_NAME references
