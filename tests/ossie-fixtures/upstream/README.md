...
https://github.com/apache/ossie/blob/88e0011148283302c9a04cd0287e00e0b9d87354/validation/validate.py

Its Apache License 2.0 header is preserved in the vendored file. The
`0.2.0.dev0` schema is the matching Apache Ossie `core-spec/osi-schema.json`
...
presented as a schema from the `88e00111` Apache commit. The dbt `0.1.0`
